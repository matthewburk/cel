...
export[...] {
  functiondef['cel.newmetacel'] {

    description = [[Creates a copy of the 'cel' metacel.]];
    ...
    returns = {
      ...
      param.table[[metatable - The metatable that is assigned to cels created with the metacel.  This is also an entry 
