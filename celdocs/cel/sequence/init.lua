...
export[...] {
  paragraph {[[A sequence is a cel that provides automatic layout.  For each link the top/left is aligned with the
  ...
  factorydef['cel.sequence'] {
    functions = {
      functiondef['__call'] {
        description = [[Creates a new sequence.  The sequence is influx until this function returns.]];
      ...
      functiondef['new'] {
        ...
        params = {
          param.number[[gap - The amount of space to leave between links in the sequence. Default is 0.]];
          param.face[[face - The face or name of the face. 
            If not a valid face for the metacel then the metacel face is used.]];
        };
